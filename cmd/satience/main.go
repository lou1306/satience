...
func run() int {
	...
	inprocessPeriod := flag.Int("inprocess", 0, "Re-simplify the ORIGINAL clause DB (subsumption+BVE) every N conflicts at level 0, on a rolling conflict-gap cadence independent of restarts (in-processing; 0=off, default)")
