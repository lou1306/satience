...
func run() int {
	...
	govUnifiedVivify := flag.Bool("gov-univ-vivify", false, "Enable the (structural-keyed) adaptive-vivify branch of the unified governor (A/B; default off)")
	// VSIDS parameters
	...
	if *govUnifiedVivify {
		s.SetGovernorUnifiedVivify(true)
	}
