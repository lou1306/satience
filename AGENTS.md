...
MiniSat Fast Suite (30s timeout): **72/72 solved (100%)**, PAR-2 2.50s (July 2026). Verified sound via minisat cross-check (`benchmark/cross_check_minisat.sh`): 0 mismatches.
