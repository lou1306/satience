...
MiniSat Fast Suite (30s timeout): **57/72 solved** (July 2026). Verified sound via minisat cross-check (`benchmark/cross_check_minisat.sh`): 57 matched instances, 0 mismatches.
